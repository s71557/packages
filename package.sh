...
git clone --depth=1 https://github.com/fw876/helloworld && mv -n helloworld/luci-app-ssr-plus ./; rm -rf ssr-plus

svn export https://github.com/xiaorouji/openwrt-passwall/main/luci-app-passwall
