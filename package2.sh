...
git clone --depth=1 https://github.com/tty228/luci-app-wechatpush luci-app-serverchan
...
git clone --depth=1 https://github.com/imy7/luci-app-turboacc && rm -rf luci-app-turboacc/lean
